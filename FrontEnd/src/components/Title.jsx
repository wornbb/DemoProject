        ...
        <div className="color-section" id="title">
            <Row>
                ...
                <Col lg={true} md={true} sm={true}>
                    ...
                    <div>
                    <Button className="btn" variant="light" size="lg" onclick="window.location.href='/signup'">
                        <i className="fas fa-user-plus" /> Sign Up
                        </Button>
                    <Button className="btn" variant="dark" size="lg" onclick="window.location.href='/login'">
